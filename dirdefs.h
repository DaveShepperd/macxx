...
#ifndef MAC_PP
#if defined(MAC_8080) || defined(MAC_Z80)
DIRDEF("DB", op_db, DFLGBM|DFLZ80 )
DIRDEF("DC", op_dc, DFLGBM|DFLZ80 )
DIRDEF("DS", op_blkm,	0|DFLZ80)
DIRDEF("DW",  op_2mau,	DFLGEV|DFLZ80)
DIRDEF("ASEG", op_asect, 0|DFLZ80 )
DIRDEF("CSEG", op_csect, 0|DFLZ80 )
DIRDEF("DSEG", op_csect, 0|DFLZ80 )
DIRDEF("END", op_end, 0|DFLZ80)
DIRDEF("DEFW", op_2mau, DFLGEV|DFLZ80)
DIRDEF("DEFS", op_blkm, 0|DFLZ80 )
DIRDEF("DEFB", op_db, DFLGBM|DFLZ80)
DIRDEF("DEFM", op_db, DFLGBM|DFLZ80)
DIRDEF("INCLUDE", op_include, 0|DFLZ80)
DIRDEF("IFDEF", op_ifallz80, DFLCND|DFLPARAM|DFLZ80)
DIRDEF("IFNDEF", op_ifallz80, DFLCND|DFLPARAM|DFLZ80)
DIRDEF("IFEQ", op_ifeqz, DFLCND|DFLPARAM|DFLZ80)
DIRDEF("IFNEQ", op_ifneqz, DFLCND|DFLPARAM|DFLZ80)
DIRDEF("ELSE", op_iff, DFLCND|DFLPARAM|DFLZ80)
DIRDEF("ENDIF", op_endc, DFLCND|DFLPARAM|DFLZ80)
DIRDEF("TITLE", op_title, 0|DFLZ80)
DIRDEF("PAGE", op_page, 0|DFLZ80)
DIRDEF("EJECT", op_page, 0|DFLZ80)
DIRDEF("LIST", op_list, 0|DFLZ80)
DIRDEF("NOLIST", op_nlist, 0|DFLZ80)
DIRDEF("ORG", op_org, 0|DFLZ80)
#endif
...
DIRDEF(".IFEQ2", op_ifall,	DFLCND|DFLPARAM)
...
DIRDEF(".IFNE2",op_ifall,	DFLCND|DFLPARAM)
