...
extern void show_bad_token( char *ptr, char *msg, int sev );
extern void bad_token( char *ptr, char *msg );
extern void err_msg( int severity, char *msg );
...
extern void puts_lis(char *string, int lines );
