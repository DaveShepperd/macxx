/*
    char_tbl65.c - Part of macxx, a cross assembler family for various micro-processors
...
unsigned short cttbl[] = {
    ...
    WS , BOP, UOP, PCX, ALP, UOP, BOP, UOP,  /*   ! " # $ % & ' */
    PCX, PCX, BOP, EXP, COM, EXP, ALP, BOP,  /* ( ) * + , - . / */
    NUM, NUM, NUM, NUM, NUM, NUM, NUM, NUM,  /* 0 1 2 3 4 5 6 7 */
    NUM, NUM, PCX, SMC, UOP, PCX, PCX, BOP,  /* 8 9 : ; < = > ? */
    ...
    ALP, ALP, ALP, PCX, BOP, PCX, UOP, ALP,  /* X Y Z [ \ ] ^ _ */
    ...
    LC , LC , LC , BOP, BOP, BOP, PCX, EOL   /* x y z { | } ~ DEL */
};
...
unsigned char cctbl[] = {
    ...
    PCX, PCX, EXP, EXP, COM, EXP, ALP, EXP,  /* ( ) * + , - . / */
    NUM, NUM, NUM, NUM, NUM, NUM, NUM, NUM,  /* 0 1 2 3 4 5 6 7 */
    NUM, NUM, PCX, SMC, EXP, PCX, EXP, EXP,  /* 8 9 : ; < = > ? */

    PCX, HEX, HEX, HEX, HEX, HEX, HEX, ALP,  /* @ A B C D E F G */
    ALP, ALP, ALP, ALP, ALP, ALP, ALP, ALP,  /* H I J K L M N O */
    ALP, ALP, ALP, ALP, ALP, ALP, ALP, ALP,  /* P Q R S T U V W */
    ALP, ALP, ALP, PCX, EXP, PCX, EXP, ALP,  /* X Y Z [ \ ] ^ _ */
