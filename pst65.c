...
Opcpst perm_opcpst[] = {
/*      name   class    base    6502    65c02      65816 */
...
OPCDEF("BRA",	03,		0x80,	0,	R,	R	)
OPCDEF("BRK",	00,		0x00,	IMP,	IMP,	IMP	)
OPCDEF("BRL",	03,		0x82,	0,	0,	RL	)
OPCDEF("BVC",	03,		0x50,	R,	R,	R	)
OPCDEF("BVS",	03,		0x70,	R,	R,	R	)
OPCDEF("BBR0",	03,		0x0F,	0,	R,	R	)
OPCDEF("BBR1",	03,		0x0F,	0,	R,	R	)
OPCDEF("BBR2",	03,		0x1F,	0,	R,	R	)
OPCDEF("BBR3",	03,		0x2F,	0,	R,	R	)
OPCDEF("BBR4",	03,		0x3F,	0,	R,	R	)
OPCDEF("BBR5",	03,		0x4F,	0,	R,	R	)
OPCDEF("BBR6",	03,		0x5F,	0,	R,	R	)
OPCDEF("BBR7",	03,		0x6F,	0,	R,	R	)
OPCDEF("BBS0",	03,		0x8F,	0,	R,	R	)
OPCDEF("BBS1",	03,		0x9F,	0,	R,	R	)
OPCDEF("BBS2",	03,		0xAF,	0,	R,	R	)
OPCDEF("BBS3",	03,		0xBF,	0,	R,	R	)
OPCDEF("BBS4",	03,		0xCF,	0,	R,	R	)
OPCDEF("BBS5",	03,		0xDF,	0,	R,	R	)
OPCDEF("BBS6",	03,		0xEF,	0,	R,	R	)
OPCDEF("BBS7",	03,		0xFF,	0,	R,	R	)
...
OPCDEF("RMB0",  02,		0x07,	0,		Z,		Z )
OPCDEF("RMB1",  02,		0x17,	0,		Z,		Z )
OPCDEF("RMB2",  02,		0x27,	0,		Z,		Z )
OPCDEF("RMB3",  02,		0x37,	0,		Z,		Z )
OPCDEF("RMB4",  02,		0x47,	0,		Z,		Z )
OPCDEF("RMB5",  02,		0x57,	0,		Z,		Z )
OPCDEF("RMB6",  02,		0x67,	0,		Z,		Z )
OPCDEF("RMB7",  02,		0x77,	0,		Z,		Z )
...
OPCDEF("SMB0",  02,		0x87,	0,		Z,		Z )
OPCDEF("SMB1",  02,		0x97,	0,		Z,		Z )
OPCDEF("SMB2",  02,		0xA7,	0,		Z,		Z )
OPCDEF("SMB3",  02,		0xB7,	0,		Z,		Z )
OPCDEF("SMB4",  02,		0xC7,	0,		Z,		Z )
OPCDEF("SMB5",  02,		0xD7,	0,		Z,		Z )
OPCDEF("SMB6",  02,		0xE7,	0,		Z,		Z )
OPCDEF("SMB7",  02,		0xF7,	0,		Z,		Z )
...

uint8_t opc_to_hex[][OP_TO_HEX_SIZE] = {
